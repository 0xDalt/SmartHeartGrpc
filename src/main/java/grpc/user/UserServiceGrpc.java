...
public final class UserServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.user.LogoutRequest,
      grpc.user.LogoutResponse> getLogoutMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "logout",
      requestType = grpc.user.LogoutRequest.class,
      responseType = grpc.user.LogoutResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.user.LogoutRequest,
      grpc.user.LogoutResponse> getLogoutMethod() {
    io.grpc.MethodDescriptor<grpc.user.LogoutRequest, grpc.user.LogoutResponse> getLogoutMethod;
    if ((getLogoutMethod = UserServiceGrpc.getLogoutMethod) == null) {
      synchronized (UserServiceGrpc.class) {
        if ((getLogoutMethod = UserServiceGrpc.getLogoutMethod) == null) {
          UserServiceGrpc.getLogoutMethod = getLogoutMethod = 
              io.grpc.MethodDescriptor.<grpc.user.LogoutRequest, grpc.user.LogoutResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "user.UserService", "logout"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.user.LogoutRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.user.LogoutResponse.getDefaultInstance()))
  ...
  public static abstract class UserServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void logout(grpc.user.LogoutRequest request,
        io.grpc.stub.StreamObserver<grpc.user.LogoutResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                grpc.user.LogoutRequest,
                grpc.user.LogoutResponse>(
  ...
  public static final class UserServiceBlockingStub extends io.grpc.stub.AbstractStub<UserServiceBlockingStub> {
    ...
    /**
     */
    public grpc.user.LogoutResponse logout(grpc.user.LogoutRequest request) {
      return blockingUnaryCall(
  ...
  public static final class UserServiceFutureStub extends io.grpc.stub.AbstractStub<UserServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.user.LogoutResponse> logout(
        grpc.user.LogoutRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_LOGOUT:
          serviceImpl.logout((grpc.user.LogoutRequest) request,
              (io.grpc.stub.StreamObserver<grpc.user.LogoutResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class UserServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.user.UserServiceImpl.getDescriptor();
    }
